...
**Why:** The style guide in AGENTS.md prohibits Write() and requires wait(0.5) before next_slide(). These fixes are included in the ADDITIONAL_INSTRUCTIONS of update tasks for this project.
