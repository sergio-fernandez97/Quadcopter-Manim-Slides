...
\label{appendix:hiperparametros}
\section{Configuración de entorno}
\begin{table}[h]
\centering
\caption{Hiperparámetros de la configuración del entorno de simulación.}
\begin{tabular}{|l|l|l|}
\hline
...
\section{Búsqueda de línea \& regularización de \acrshort{ilqr}}
\begin{table}[H]
\centering
\caption{Parámetros de búsqueda de línea y regularización para \acrshort{ilqr}.}
\begin{tabular}{|l|l|l|}
\hline
\textbf{Símbolo} & \textbf{Significado} & \textbf{Valor} \\ \hline
...
\begin{table}[H]
\centering
\caption{Hiperparámetros del entrenamiento con \acrshort{ddpg}.}
\begin{tabular}{|l|l|l|}
\hline
\textbf{Símbolo} & \textbf{Significado} & \textbf{Valor} \\ \hline
...
\begin{table}[H]
\centering
\caption{Parámetros del ruido \acrshort{ou}.}
\begin{tabular}{|l|l|l|}
\hline
\textbf{Símbolo} & \textbf{Significado} & \textbf{Valor} \\\hline
...
\begin{table}[h]
\centering
\caption{Hiperparámetros del entrenamiento con \acrshort{gps}.}
\begin{tabular}{|l|l|l|}
\hline
\textbf{Símbolo} & \textbf{Significado} & \textbf{Valor} \\ \hline
