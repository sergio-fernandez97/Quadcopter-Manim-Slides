...
user-invocable: true
allowed-tools: Read Write Edit Agent Bash(git:*) Bash(uv run:*) Bash(gh:*) Bash(.claude/scripts/bootstrap_dev_branch.sh:*) Bash(.claude/scripts/prepare_slide_branch.sh:*) Bash(.claude/scripts/publish_slide_pr.sh:*) mcp__context7__resolve-library-id mcp__context7__query-docs
...
4. PR tool preference:
   - prefer the configured GitHub MCP/app in the Claude environment
